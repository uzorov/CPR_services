<template>
  <v-card class="task-card">
    ...
    <v-card-subtitle>
      <div>
        <v-select
          v-if="!isTaskNotAssignedToCurrentUser"
      ...
      <div>Дата регистрации: {{ task.registration_date }}</div>
    ...
    <v-card-actions>
      <v-btn v-if="isTaskNotAssignedToCurrentUser" color="primary" small @click="$emit('edit-task', task)">Редактировать</v-btn>
